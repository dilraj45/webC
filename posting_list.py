...
def recursiveChildren(x):
    ...
    # With "childGenerator" in dir(x) we make sure that an element is a
    # container, terminal nodes such as NavigableStrings are not containers
...
if __name__ == "__main__":
    ...
    result_file = open('result.txt', 'w')
    # USING MODULEEEEES
    html_text = obj.get_html_text(base)
